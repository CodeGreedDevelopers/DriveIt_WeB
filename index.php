...
<link rel="stylesheet" href="car_class/cars.css" type="text/css">
...
<script src="assets/js/maps.js"></script>
    <script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyADgG1Q6wqHTrzKUYsv-YSNjsTV-0ewKK4&callback=initMap">
    </script> 
</head>
<body>
...
<?php $sql = "SELECT tblvehicles.VehiclesTitle,tblvehicles.Vtype,tblvehicles.numDoors,tblvehicles.top_speed,tblvehicles.Vmilage,tblvehicles.Vcolor,tblvehicles.Vpower,tblvehicles.Vgearbox,tblbrands.BrandName,tblvehicles.PricePerDay,tblvehicles.FuelType,tblvehicles.ModelYear,tblvehicles.id,tblvehicles.SeatingCapacity,tblvehicles.VehiclesOverview,tblvehicles.Vimage1 from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand";
...
<div id="map" style="width: 90vw; height: 90vh;background-color: grey; margin: 0 auto;"></div>
...
<!--/Forgot-password-Form -->
<!-- making navbar fixed after some scroll --> 
...
<script type="text/javascript">
  ...
  $(window).scroll(function () { 
    ...
    if ($(window).scrollTop() >132) {
      $('#navigation_bar').addClass('navbar-fixed-top');
    }

    if ($(window).scrollTop() < 133) {
      $('#navigation_bar').removeClass('navbar-fixed-top');
    }
  });
});
</script>
