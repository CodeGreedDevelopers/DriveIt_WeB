...
if ($company=="") {
  $company_name="Car Listing";
  $top='<li>Top Cars</li>';
}else{
  $company_name=$_POST['company_name'];
  $top='<li><a href="#">Companies</a></li><li>'.$company_name.'</li>';
}
  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1><?php echo htmlentities($company_name);?></h1>
      </div>
...
if ($company==""){
  ...
  $sql = "SELECT id from tblvehicles where tblvehicles.company_id=:company";
  $query = $dbh -> prepare($sql);
...
if ($company=="") {
  ...
  $sql = "SELECT tblvehicles.*,tblbrands.BrandName,tblbrands.id as bid  from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand where tblvehicles.company_id=:company";
  $query = $dbh -> prepare($sql);
  $query->bindParam(':company',$company,PDO::PARAM_STR);
  $query->execute();
  $results=$query->fetchAll(PDO::FETCH_OBJ);
