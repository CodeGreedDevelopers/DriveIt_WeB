...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyADgG1Q6wqHTrzKUYsv-YSNjsTV-0ewKK4&libraries=places"></script>
<script>
              function initMap() {
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              <input type="text" class="form-control" id="searchInput" name="todate" placeholder="Pick Up Location" required>
            </div>
            <div class="form-group">
